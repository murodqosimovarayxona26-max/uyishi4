...
# No3# for i in ("rayhona"):
#     print(i)
# No4
# for i in range(1,6):
#     print(i,"ning kvadrati=",i**2)
# NO5# a=["olma","kiwi","nok","gilos"]
# for i in a:#     print(i)
# No6
#s=0
...
# d=float(input("to'rtinchi son: "))
# e=float(input("beshinchi son: "))
# k=5
# s=0
# for i in (a,b,c,d,e):
#     s=s+i
# print("o'rtacha qiymat",s/k)
#No8
# for i in range(1,10)[::-1]:
# print(i)
# While sikli misollari
#No9
# i=1
# while i<5:
#     print(i)
...
# print("barakallo togri bajarildi")
# BREAK va CONTINUE misollari
#No15
# for i in range (1,10):
#     if i==5:
#         break
#     print(i)
#No16# for i in range (1,10):
#     if i==5:
#         continue
#     print(i)
#No17
